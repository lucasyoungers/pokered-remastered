...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 28, ONIX, 29, RHYHORN, 31, KANGASKHAN, 0
; Silph Co. 11F
	db $FF, 38, NIDORINO, 41, RHYHORN, 43, KANGASKHAN, 43, NIDOQUEEN, 0
; Viridian Gym
	db $FF, 50, DUGTRIO, 50, BEEDRILL, 50, GOLEM, 52, NIDOQUEEN, 52, NIDOKING, 55, RHYDON, 0
...
BrunoData:
	db $FF, 56, HITMONCHAN, 56, HITMONLEE, 57, ONIX, 60, PRIMEAPE, 60, POLIWRATH, 64, MACHAMP, 0

BrockData:
	db $FF, 12, GEODUDE, 14, ONIX, 0

MistyData:
	db $FF, 18, HORSEA, 20, STARYU, 21, STARMIE, 0

LtSurgeData:
	db $FF, 21, MAGNEMITE, 20, VOLTORB, 26, RAICHU, 30, ELECTABUZZ, 0

ErikaData:
	db $FF, 25, EXEGGCUTE, 29, TANGELA, 32, VICTREEBEL, 32, VILEPLUME, 0

KogaData:
	db $FF, 34, MUK, 35, GOLBAT, 35, TENTACRUEL, 38, ARBOK, 41, WEEZING, 0

BlaineData:
	db $FF, 42, FLAREON, 43, MAGMAR, 45, RAPIDASH, 48, NINETALES, 50, ARCANINE, 0
...
; Route 22
	db $FF, 47, SCYTHER, 45, TAUROS, 45, GROWLITHE, 47, EXEGGCUTE, 50, ALAKAZAM, 53, BLASTOISE, 0
	db $FF, 47, SCYTHER, 45, TAUROS, 45, GYARADOS, 47, GROWLITHE, 50, ALAKAZAM, 53, VENUSAUR, 0
	db $FF, 47, SCYTHER, 45, TAUROS, 45, EXEGGCUTE, 47, GYARADOS, 50, ALAKAZAM, 53, CHARIZARD, 0

Green3Data:
	db $FF, 63, SCYTHER, 64, TAUROS, 66, ARCANINE, 66, EXEGGUTOR, 69, BLASTOISE, 70, MEWTWO, 0
	db $FF, 63, SCYTHER, 64, TAUROS, 66, GYARADOS, 66, ARCANINE, 69, VENUSAUR, 70, MEWTWO, 0
	db $FF, 63, SCYTHER, 64, TAUROS, 66, EXEGGUTOR, 66, GYARADOS, 69, CHARIZARD, 70, MEWTWO, 0

LoreleiData:
	db $FF, 54, DEWGONG, 54, CLOYSTER, 55, SLOWBRO, 56, JYNX, 58, LAPRAS, 61, ARTICUNO, 0
...
AgathaData:
	db $FF, 58, WEEZING, 58, MAROWAK, 60, GOLDUCK, 62, NINETALES, 65, GENGAR, 66, MOLTRES, 0

LanceData:
	db $FF, 60, GYARADOS, 60, AERODACTYL, 62, SEADRA, 64, CHARIZARD, 65, DRAGONITE, 68, ZAPDOS, 0
